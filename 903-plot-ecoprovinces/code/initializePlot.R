...
initializePlot <- function(
    ...
    my.ggplot <- my.ggplot + ggplot2::theme(
        ...
        panel.grid.major = ggplot2::element_line(colour = "gray", linetype = 2, linewidth = 0.25),
        panel.grid.minor = ggplot2::element_line(colour = "gray", linetype = 2, linewidth = 0.25)
        );
